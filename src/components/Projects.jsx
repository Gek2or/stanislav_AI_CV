...
const ui = {
  ...
  ru: {
    ...
    case: 'CASE 01', live: 'РЕАЛЬНЫЙ БИЗНЕС', flowTitle: 'ОПЕРАЦИОННЫЙ ПРОЦЕСС', active: 'ДРУГОЙ ПРАКТИЧЕСКИЙ КОНТЕКСТ',
    ...
    facts: [
      ...
      ['Software-направление', 'Превращать повторяющиеся этапы в инструменты для предложений, учёта, структурированных данных и будущих API-интеграций.'],
    ],
    flow: [
    ...
    selectedLabels: ['БИЗНЕС-АВТОМАТИЗАЦИЯ', 'SOFTWARE-ПРОТОТИП', 'СИСТЕМА WORKFLOW'],
  },
  uk: {
    ...
    case: 'CASE 01', live: 'РЕАЛЬНИЙ БІЗНЕС', flowTitle: 'ОПЕРАЦІЙНИЙ ПРОЦЕС', active: 'ІНШИЙ ПРАКТИЧНИЙ КОНТЕКСТ',
    ...
    facts: [
      ...
      ['Software-напрям', 'Перетворювати повторювані етапи на інструменти для пропозицій, обліку, структурованих даних і майбутніх API-інтеграцій.'],
    ],
    flow: [
    ...
    selectedLabels: ['БІЗНЕС-АВТОМАТИЗАЦІЯ', 'SOFTWARE-ПРОТОТИП', 'СИСТЕМА WORKFLOW'],
  },
}
